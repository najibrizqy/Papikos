  ...
  render() {
    return (
      <Container>
        ...
        <Right><Button transparent onPress={()=>ActionSheet.show(
              {
                options: BUTTONS,
        ...
        <Tabs style={{overflow:'hidden'}}>
          <Tab heading={ <TabHeading style={{backgroundColor: '#1AB0D3'}}><Icon name="home" /><Text>Home</Text></TabHeading>}>
            <Home navigation={this.props.navigation}/>
          </Tab>
          <Tab heading={ <TabHeading style={{backgroundColor: '#1AB0D3'}}><Icon name="chatboxes" /><Text>Chats</Text><Badge><Text>2</Text></Badge></TabHeading>}>
            <Text>Test lagi</Text>
          </Tab>
