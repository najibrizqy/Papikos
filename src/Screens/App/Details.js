...
class Details extends Component {
  constructor(props){
    super(props);
    this.state = {
      entries:[{title: 'Kamar',thumbnail:'https://cdn-image.hipwee.com/wp-content/uploads/2017/07/hipwee-kosan3-750x422.jpg'},
      {title:'Toilet',thumbnail:'https://pix6.agoda.net/hotelImages/4917129/0/28544d88c04c166c2e09fdce6cddb2e0.jpg?s=1024x768'},
      {title:'Parkir',thumbnail:'https://cdn-image.hipwee.com/wp-content/uploads/2014/12/Kost-Keputih-Lt-1-parkir-motor-750x562.jpg'}]
    }
  }
        ...
        return (
          ...
          <View style={styles.deletebutton}>
            ...
            <Footer style={{backgroundColor: 'white'}}>
              <Left style={{paddingHorizontal:10}}><Body>
                <Text style={{fontSize:18,fontWeight:'bold'}}>Rp 500.000/month</Text>
